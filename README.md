...
- ▸ Détection de fraudes et anomalies avec `XGBoost` / `SVM`
- ▸ Chatbots & automatisation avec `Python` + `SharePoint`
- ▸ Analyse de KPIs réseaux mobiles 2G/3G/4G
- ▸ Exploration en cybersécurité offensive & défensive
